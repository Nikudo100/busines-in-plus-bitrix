...
; /* Start:"a:4:{s:4:"full";s:65:"/local/templates/busines-in-plus/assets/js/main.js?17100691134296";s:6:"source";s:50:"/local/templates/busines-in-plus/assets/js/main.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
document.addEventListener("DOMContentLoaded", function() {
  const downloadLink = document.querySelector('.download-brif');
  const fileUrl = 'upload/doc/brif.pdf'; // Путь к файлу
  ...
  function downloadFile(url) {
    ...
    link.href = url;
    link.target = '_blank'; // Открываем файл в новой вкладке, если браузер позволяет
    link.setAttribute('download', ''); // Атрибут download указывает браузеру скачать файл вместо открытия его в новой вкладке
    document.body.appendChild(link);
    link.click();
    link.remove(); // Удаляем ссылку из DOM, когда скачивание завершено
  }
...
/* End */
;; /* /local/templates/busines-in-plus/assets/js/main.js?17100691134296*/
; /* /local/templates/.default/components/bitrix/menu/menu_footer/script.min.js?17100686754034*/

//# sourceMappingURL=template_30bfa5f7ba20f1c5972b298cd09b432e.map.js