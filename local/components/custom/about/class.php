...
class CustomElementComponentAbout extends CBitrixComponent
{
    public function executeComponent()
    {
        ...
        if ($element = $res->fetch()) {
            ...
            $opportRes = PropertyTable::getList(array(
                'filter' => array(
                    'IBLOCK_ID' => $iblockId,
                    'CODE' => array('GALLERY', 'TEXT_SERT','SERT1','SERT2','DATAS','PEOPLES','CLIENTS','TEXT_GR')
                )
            ));
            ...
            $this->arResult["PROPS"] = $opportunities;
