        ...
        <div class="be">
            ...
            <form class="be-form" action="<?= POST_FORM_ACTION_URI ?>" method="POST">
                ...
                <div class="be-form-row e-3">
                    <input placeholder="Фамилия *" require type="text" name="user_last_name" value="<?= $arResult["AUTHOR_LAST_NAME"] ?>">
                    <input placeholder="Имя *" require type="text" name="user_name" value="<?= $arResult["AUTHOR_NAME"] ?>">
                    <input placeholder="Компания *" require type="text" name="user_company" value="<?= $arResult["AUTHOR_COMPANY"] ?>">
                </div>
                <div class="be-form-row e-2">
                    <input placeholder="Вид деятельности *" require type="text" name="user_activity" value="<?= $arResult["AUTHOR_ACTIVITY"] ?>">
                    <input placeholder="Город *" require type="text" name="user_city" value="<?= $arResult["AUTHOR_CITY"] ?>">
                </div>
                <div class="be-form-row e-3">
                    <input placeholder="Должность" type="text" name="user_position" value="<?= $arResult["AUTHOR_POSITION"] ?>">
                    <input placeholder="Телефон *" require type="text" name="user_phone" value="<?= $arResult["AUTHOR_PHONE"] ?>">
                    <input placeholder="E-mail *" require type="text" name="user_email" value="<?= $arResult["AUTHOR_EMAIL"] ?>">
                </div>
