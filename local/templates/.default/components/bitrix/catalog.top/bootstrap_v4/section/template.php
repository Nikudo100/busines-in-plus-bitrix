			...
			<ul>
				<? foreach ($arResult["ITEMS"] as $arItem) : ?>
					...
					<li class="news-item-obuch" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
						...
						?>
						<a href="<? echo $arItem["DETAIL_PAGE_URL"] ?>"><span class="obuch-date">
								<?= $date->format('d.m.y'); ?></span> <? echo $arItem["NAME"] ?>
						</a>
					</li>
				<? endforeach; ?>
			</ul>
			<button class="question">Задать свой вопрос</button>
		</div>
		<!-- items-container -->
	<?
	} else {
