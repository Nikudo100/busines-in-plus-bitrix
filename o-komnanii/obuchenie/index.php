...
<div class="container">
	<? $APPLICATION->IncludeComponent("bitrix:catalog", "obuch", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"ELEMENT_SORT_FIELD" => "timestamp_x",	// По какому полю сортируем товары в разделе
		...
		"SEF_FOLDER" => "/o-komnanii/obuchenie/",	// Каталог ЧПУ (относительно корня сайта)
